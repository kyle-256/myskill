...
## copy-atom 移植坑（raw buffer_ops → FlyDSL layout API）（FlyDSL fork 的 layout API）
...
---
来源: gemm-optimization/SKILL.md, flydsl-kernel-authoring/SKILL.md, capture-kernel-trace/SKILL.md, optimization-directions.md, gemm/optimization-directions.md, port-to-layout-api/SKILL.md
