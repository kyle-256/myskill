...
- [`remote-mlperf-gptoss/`](remote-mlperf-gptoss/SKILL.md) —— 连接远程计算节点（当前 chi2774，以 ssh config 为准），进入 mlperf_gptoss 容器在 /workspace/code 下操作。⚠️ 跑 flydsl kernel 要 `PYTHONPATH=/workspace/code/FlyDSL/python`。
